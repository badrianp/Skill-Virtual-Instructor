...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2021 at 03:23 PM
...
(4, 'Learn the basics of CPR on adults', 'cpr', 'WikiHow', 'cpr.jpg', 'Learn how to properly help an unconscious person. Please use a mannequin for a more hands-on experience', 45, 'Medium', 2, 'Any medical experience is welcome'),
...
(6, 'Basic Knots For Begginers', 'knotting', 'Rutendo Rajeev', 'knots.jpg', 'This guide will teach some of these basic knots so that you can use them whenever the need arises. So grab your rope and start knotting!', 50, 'Begginer', 4, 'No prior experience needed');
...
--
-- Table structure for table `knotting`
--

CREATE TABLE `knotting` (
  `id` int(10) NOT NULL,
  `course_id` int(10) NOT NULL,
  `name` varchar(255) NOT NULL,
  `image` varchar(100) NOT NULL,
...
--
-- Dumping data for table `knotting`
--

INSERT INTO `knotting` (`id`, `course_id`, `name`, `image`, `json`) VALUES
(1, 6, 'How to tie the Square Knot', 'squareknt', 'knt1'),
(2, 6, 'How to tie the Surgeon Knot', 'surgeonknt', 'knt2'),
(3, 6, 'How to tie the Clove Hitch Knot', 'cloveknt', 'knt3'),
(4, 6, 'How to tie the Bowline Knot', 'bowknt', 'knt4');
...
--
-- Indexes for table `knotting`
--
ALTER TABLE `knotting`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `json` (`json`);

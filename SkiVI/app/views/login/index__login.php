...
<body>
    ...
    <div class="main-div">
        ...
        <form class="credentials-form" id="login-form" name="login-form" method="POST">
        ...
        <form class="credentials-form" id="register-form" name="register-form" method="POST">
            ...
            <div class="input-div">
                ...
                <label class="input-label" for="register-full-name">
                    <span>Full Name:</span>
                    <input type="text" name="full-name" class="input-area" id="register-full-name" required placeholder="John Snow">
                </label>

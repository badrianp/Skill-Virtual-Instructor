...
<body onload="generateDOM(<?= $data['category'] ?>, <?= $data['syntax'] ?>)">
    ...
    <div class="search-bar">
        ...
        <button id="knotting">Knotting</button>
    ...
    <div class="side-div">
        ...
        <a class="category-button" href="<?= $data['syntax'] ?>course/category/knotting" id="knotting">Knotting</a>

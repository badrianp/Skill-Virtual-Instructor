        ...
        <form class="credentials-form" id="register-form" name="register-form" method="POST" action="<?= $data['syntax'] ?>auth/register">
            ...
            <div class="input-div">
                ...
                <label class="input-label" for="register-email">
                    <span>Email:</span>
                    <input type="email" name="email" class="input-area" id="email" required placeholder="email@example.dd">
                </label>
                ...
                <label class="input-label" for="register-username">
                    <span>Username:</span>
                    <input type="text" name="username" class="input-area" id="username" required placeholder="userName">
                </label>
